...
public static class TarotZodiacs
{
    ...
    public static TarotZodiac Aries => new(
        "Aries",
        new DateOnly(Year, 3, 19),
        new DateOnly(Year, 4, 19),
        TarotElements.Fire,
    ...
    public static TarotZodiac Taurus => new(
        "Taurus",
        new DateOnly(Year, 4, 20),
        new DateOnly(Year, 5, 20),
        TarotElements.Earth,
        TarotModalities.Fixed,
        TarotPlanets.Venus,
        new string[]{
    ...
    public static TarotZodiac Gemini => new(
        "Gemini",
        new DateOnly(Year, 5, 21),
        new DateOnly(Year, 6, 20),
        TarotElements.Air,
    ...
    public static TarotZodiac Cancer => new(
        "Cancer",
        new DateOnly(Year, 6, 21),
        new DateOnly(Year, 7, 22),
        TarotElements.Water,
    ...
    public static TarotZodiac Leo => new(
        "Leo",
        new DateOnly(Year, 7, 23),
        new DateOnly(Year, 8, 22),
        TarotElements.Fire,
        TarotModalities.Fixed,
        TarotPlanets.Sun,
        new string[]{
    ...
    public static TarotZodiac Virgo => new(
        "Virgo",
        new DateOnly(Year, 8, 23),
        new DateOnly(Year, 9, 22),
        TarotElements.Earth,
        TarotModalities.Mutable,
        TarotPlanets.Mercury,
        new string[]{
    ...
    public static TarotZodiac Libra => new(
        "Libra",
        new DateOnly(Year, 9, 23),
        new DateOnly(Year, 10, 22),
        TarotElements.Air,
        TarotModalities.Cardinal,
        TarotPlanets.Venus,
        new string[]{
    ...
    public static TarotZodiac Scorpio => new(
        "Scorpio",
        new DateOnly(Year, 10, 23),
        new DateOnly(Year, 11, 21),
        TarotElements.Water,
        TarotModalities.Fixed,
        TarotPlanets.Pluto,
        new string[]{
    ...
    public static TarotZodiac Sagittarius => new(
        "Sagittarius",
        new DateOnly(Year, 11, 22),
        new DateOnly(Year, 12, 21),
        TarotElements.Fire,
        TarotModalities.Mutable,
    ...
    public static TarotZodiac Capricorn => new(
        "Capricorn",
        new DateOnly(Year, 12, 22),
        new DateOnly(Year, 1, 19),
        TarotElements.Earth,
        TarotModalities.Cardinal,
        TarotPlanets.Saturn,
        new string[]{
